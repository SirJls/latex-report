...
if [[ ! -e .git ]]; then
    ...
    git init
    git submodule add https://github.com/SirJls/latex-report.git latex-report
    git add .
    ...
    log INFO "> git submodule add https://github.com/SirJls/latex-report.git latex-report"
fi
